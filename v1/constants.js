...
const TABLE_NODE_TYPES = [EXISTENTIAL, AMBIVALENT, GOOD, INTERMEDIATE, NORMAL];
const TABLE_HEADERS = ["Existential Catastrophe", "Ambivalent Outcome", "Good Outcome", "Intermediate State", "Question Nodes (propability<br>of *entering* this node)"];
